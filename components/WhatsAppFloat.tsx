...
export default function WhatsAppFloat({ config }: { config: FunnelConfig }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 hidden h-14 w-14 items-center justify-center rounded-full bg-whatsapp shadow-lg shadow-black/40 transition hover:scale-110 sm:flex"
    >
